...
use crate::{
    AssembledBlock, AuditWindowSnapshot, BlockAssembler, CachedFlashblock, ExecutionError,
    FastFlashblockFeedEvent, FastFlashblockLogsDelta, FlashblockCache, FlashblocksMode,
    HotApplyOutcome, HotEngine, HotInvalidationReason, HotSnapshot, HotSnapshotRing,
    LatestHotDryRunSeedCache, PendingBlocks, PendingBlocksBuilder, PendingStateBuilder,
    PeriodicAuditFailure, PeriodicAuditResult, ProviderError, Result, ShadowRebuildCompletion,
    SnapshotCache, StateProcessorError,
    metrics::Metrics,
    validation::{
...
mod tests {
    ...
    async fn hot_only_canonical_conflict_without_retained_proof_resets_to_resync() {
        ...
        .block;
        processor
            .apply_hot_only_canonical(RecoveredBlock::new_unhashed(
