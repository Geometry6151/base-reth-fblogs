...
mod tests {
    ...
    fn build_request_state_clones_seed_for_request_local_mutation() {
        ...
        seed.execution_seed.cache.has_state_clear = true;
        ...
        seed.execution_seed.bal_state.bal_index = 9;

        let mut request_state = seed.build_request_state(InMemoryDB::default());
        request_state.cache.has_state_clear = false;
        ...
        request_state.bal_state.bal_index = 0;

        assert!(seed.execution_seed.cache.has_state_clear);
        ...
        assert_eq!(seed.execution_seed.block_hashes.len(), 1);
        assert_eq!(seed.execution_seed.bal_state.bal_index, 9);
    }
}
